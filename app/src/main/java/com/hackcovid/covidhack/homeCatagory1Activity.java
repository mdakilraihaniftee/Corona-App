...
public class homeCatagory1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_catagory1);
    ...
    private void fetchData() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            JSONArray jsonArray=new JSONArray(response);
                                ...
                                ContinentText.setText(jsonObject.getString("continent"));
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(homeCatagory1Activity.this);
